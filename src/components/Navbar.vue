    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-20">
        ...
        <div class="hidden lg:flex lg:items-center lg:space-x-8">
          <RouterLink to="/" class="nav-link" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">{{ $t('nav.home') }}</RouterLink>
          <RouterLink to="/nosotros" class="nav-link" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="400">{{ $t('nav.about') }}</RouterLink>
          <RouterLink to="/nuestra-carta" class="nav-link" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="500">{{ $t('nav.menu') }}</RouterLink>
          <RouterLink to="/contacto" class="nav-link" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="600">{{ $t('nav.contact') }}</RouterLink>
          <ThemeSwitcher />
          <LanguageSwitcher />
        </div>
        ...
        <div class="lg:hidden flex items-center">
          <ThemeSwitcher />
          <LanguageSwitcher />
          <button @click="toggleMenu" class="text-white dark:text-white hover:text-black dark:hover:text-white focus:outline-none ml-4">
    ...
    >
      <div v-if="isMenuOpen" class="lg:hidden bg-light/95 dark:bg-dark/95 backdrop-blur-sm">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <RouterLink to="/nuestra-carta" @click="isMenuOpen=false" class="nav-link-mobile">{{ $t('nav.menu') }}</RouterLink>
